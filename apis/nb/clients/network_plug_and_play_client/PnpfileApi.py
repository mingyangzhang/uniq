...
class PnpfileApi(object):
    ...
    def getConfigs(self, **kwargs):
        ...
        Args:
            ...
            extension, str: File extension. txt,vm,gen,json etc. Accepts a list of extensions (required)
        ...
        allParams = ['offset', 'limit', 'name', 'extension', 'scope']
    ...
    def getConfigCount(self, **kwargs):
        ...
        allParams = ['name', 'extension', 'scope']
