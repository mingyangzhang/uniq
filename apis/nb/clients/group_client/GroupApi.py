...
class GroupApi(object):
    ...
    def getUnassignedMembers(self, **kwargs):
        ...
        allParams = ['offset', 'limit', 'groupType', 'memberType']

        params = locals()
        for (key, val) in list(params['kwargs'].items()):
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method getUnassignedMembers" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/group/unassigned'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
    ...
    def getUnassignedMemberCount(self, **kwargs):
        ...
        allParams = ['groupType', 'memberType']

        params = locals()
        for (key, val) in list(params['kwargs'].items()):
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method getUnassignedMemberCount" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/group/unassigned/count'
        resourcePath = resourcePath.replace('{format}', 'json')
        method = 'GET'
